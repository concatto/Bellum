...
public interface GameConstants {
	...
	public static final float CANNONBALL_DAMAGE_COEF = 24.8f;
	...
	public static final float HEALTH_PICKUP_CHANCE = 0.0000045f;
	public static final float SPECIAL_PICKUP_CHANCE = 0.0000025f;
